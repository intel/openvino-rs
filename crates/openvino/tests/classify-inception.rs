//! Demonstrates using `openvino-rs` to classify an image using an Inception SSD model and a
//! prepared input tensor. See [`fixtures::inception`] for details on how this test fixture was
//! prepared.
mod fixtures;
mod util;
